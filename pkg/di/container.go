...
// DepFactoryFunc representing for dependency factory function
//
//	func(c Container) (any, error) {
//		return NewUserRepository(
//			opentelemetry.Trace(c.Get(constants.DBConnectionKey).(*sql.Tx)),
//		), nil
//	}
...
// New initialize an dependency injection container
func New() Container {
	return &container{
